...
class TestOrderTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StatefulWrapper(
      onInit: () {
        Provider.of<TestOrderListController>(context, listen: false)
            .getOrderList();
      },
                  ...
                  child: DataTable2(
                      ...
                      rows: List<DataRow>.generate(
                          ...
                          (index) => DataRow(cells: [
                                ...
                                DataCell(Text(data.orderList[index].unitPrice
                                    .toString())),
                                DataCell(data.orderList[index].offerPrice == 0
                                    ...
                                    : Text(data.orderList[index].offerPrice
                                        .toString())),
                                DataCell(Text(
                                    data.orderList[index].total.toString())),
                                DataCell(IconButton(
                                  onPressed: () {},
