                ...
                data.isLoading
                    ...
                    : DataTable2(
                        ...
                        rows: List<DataRow>.generate(
                            ...
                            (index) => DataRow(cells: [
                                  DataCell(
                                      data.product.data.products[index].image !=
                                              null
                                          ? Image.network(
                                  ...
                                  DataCell(Text(
                                      data.product.data.products[index].name)),
                                  DataCell(Text(
                                      data.product.data.products[index].isVeg
                                          ? 'Veg'
                                          : 'Non-Veg')),
                                  DataCell(Center(
                                    child: Text(
                                      data.product.data.products[index]
                                          .description == 'null' ? '-' : data.product.data.products[index]
                                          .description!,
                                      maxLines: 10,
                                      style: TextStyle(
                                          overflow: data
